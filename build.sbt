...
val catsEffects     = "org.typelevel" %% "cats-effect"         % "3.2.1"
val munitCatsEffect = "org.typelevel" %% "munit-cats-effect-3" % "1.0.5" % Test
val circeV          = "0.14.1"
val scalapbV        = "0.11.4"
...
val `protobuf-kafka` = project
  ...
  .settings(
    ...
    libraryDependencies ++= List(
      ...
      "org.apache.kafka"     %% "kafka-streams-scala"       % "2.6.2",
